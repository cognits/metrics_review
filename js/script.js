$(window).load(function(){
    ...
    query.find({
        ...
        for(x=0; x<=Lines.length;x++){
                ...
                var TotalLineCode = ProjectLines[0];
        }
        if(TotalLineCode>=10000){
            var TotalLineCode = TotalLineCode.toString();
            var TotalLineCode = TotalLineCode.substring(0,2);
            var TotalLineCode = TotalLineCode+"K";
        }
        //----------------------------Fin del Ciclo de Resultados--------------------------
        //---------------------Function for the grafic de time finish QA and reviewer time One Grafic-----------------------\\
        $('#reviewandqa').highcharts({
            chart: {
                type: 'column'
            },
            title: {
            ...
            series: [{
                ...
                color: Highcharts.getOptions().colors='skyblue'
                ...
                color: Highcharts.getOptions().colors='#FF4E50'
            }]
        });
        //---------------------------------------Finish graphics------------------------------------------------\\
        ...
        $(function () {
            ...
            $('#maxtime').highcharts({
                ...
                series: [{
                    ...
                    name: 'Comments',
                    data: [
                        ['QA', parseInt(QAMinutesTotal)],
                        ['Review', parseInt(ReviewMinutesTotal)],
                    ]
                }]
            });
        });
        ...
        $(function () {
            ...
            // The QA
            $('#qa').highcharts(Highcharts.merge(gaugeOptions, {
                yAxis: {
                    min: 0,
                    max: 100,
                    title: {
            ...
            // The RPM gauge
            $('#review').highcharts(Highcharts.merge(gaugeOptions, {
                yAxis: {
                    min: 0,
                    max: 100,
                    title: {
        ...
        $(function () {
            ...
            $('#Grafi').highcharts({
                ...
                title: {
                    text: 'Awesome, Nitpick and Critical Comments',
                    style: {
                        "color":"white",
                    }
                },
        ...
        //---------------------------------------Finish graphics------------------------------------------------\\	
        $(".TimeReview").append('<h1>'+ReviewMinutesTotal+'</h1>'+'<p>Hours of Review</p>');
        $(".QATime").append('<h1>'+QAMinutesTotal+'</h1>'+'<p>Hours of QA</p>')
        ...
        $(".LineCode").append('<h1>'+TotalLineCode+'</h1>'+'<p>Lines of Code'+'</p>');
